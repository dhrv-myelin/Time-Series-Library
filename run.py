...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="whether to use time variant dt for MambaSL",
    )
    parser.add_argument(
        "--tv_B", type=int, default=0, help="whether to use time variant B for MambaSL"
    )
    parser.add_argument(
        "--tv_C", type=int, default=0, help="whether to use time variant C for MambaSL"
    )
    parser.add_argument(
        "--use_D", type=int, default=0, help="whether to use D for MambaSL"
    )
    ...
    # GPU
    parser.add_argument(
        "--use_gpu", action="store_true", default=True, help="use gpu (default: on)"
    )
    parser.add_argument(
        "--no_use_gpu",
        action="store_false",
        dest="use_gpu",
        help="disable gpu (force cpu)",
    )
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            if args.model == "MambaSingleLayer" and args.task_name == "classification":
                setting = (
                    f"{args.task_name}_CLS_{args.model_id}_{args.model}_{args.data}_ft{args.features}"
